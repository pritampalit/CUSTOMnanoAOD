...
#input_file = os.environ.get('INPUT_FILE', 'default_input.root')
#output_file = os.environ.get('OUTPUT_FILE', 'default_output.root')
...
process.NANOAODoutput = cms.OutputModule("NanoAODOutputModule",
                                         ...
                                         fileName = cms.untracked.string('Run3_2023_PAT_EXONANO_template_test_TT_Puppi_CHS.root'),
...
from PhysicsTools.CUSTOMnanoAOD.custom_displacedtau_cff import *
#process = nanoAOD_customizeAddAK4CHS(process) # Addition of CHS only without DisTauTag score to Puppi
process = add_displacedtauCHSTables(process, 1) # Addition of CHS with DisTauTag score to Puppi
# DisplacedTau customisation

# Replace AK4 Puppi with AK4 CHS for Run-3 along with for CMSSW_pre_15_x
# This block will move before BTVCustomNanoAODStaus in case of having PFCandidate collection

#use_CHS_jets=True
#run3modifier_chs(process, useCHSJets = use_CHS_jets)
#process = add_displacedtauTables(process, 1, useCHSJets = use_CHS_jets)
